...
public class DetailsBusinessInfoTabFragment extends Fragment implements APIResponseListner {
    ...
    @SuppressLint("ValidFragment")
    public DetailsBusinessInfoTabFragment(TabChangeListner tabChangeListner) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.details_business_info_tab_layout, container, false);
    ...
    void apiCall(boolean loader) {
        ...
        if (isSearchedText) {
            ...
            new VollyAPICall(view.getContext(), false, URL.get_budz_profile + "/" + budz_map_item_clickerd_dataModel.getId() + "?keyword=" + isSearchedTextValue, object, user.getSession_key(), Request.Method.GET, DetailsBusinessInfoTabFragment.this, get_budz_profile);
//            isSearchedTextValue = "";
        } else {
            if (isKeyy) {
            ...
            if (budz_map_item_clickerd_dataModel != null) {
                JSONObject object = new JSONObject();
                new VollyAPICall(view.getContext(), false, URL.get_budz_profile + "/" + budz_map_item_clickerd_dataModel.getId(), object, user.getSession_key(), Request.Method.GET, DetailsBusinessInfoTabFragment.this, get_budz_profile);
            }
        }
//+ "?keywrod=" + ""
...
//            JSONArray reviews_array = jsonObject.getJSONObject("successData").getJSONArray("review");
            ...
            new SetReviewaAndComments().InitData(getContext(), DetailsBusinessInfoTabFragment.this, view, reviews, jsonObject.getJSONObject("successData").getInt("get_user_review_count"));
