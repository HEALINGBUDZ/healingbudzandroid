package com.codingpixel.healingbudz.customeUI.multiselect;
...
public class MultiSelectDialog extends AppCompatDialogFragment implements SearchView.OnQueryTextListener, View.OnClickListener, TextWatcher {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        EditText searchView = dialog.findViewById(R.id.search_view);
        ...
        if (view.getId() == R.id.done) {
            ...
            if (callBackListOfIds.size() >= minSelectionLimit) {
                if (callBackListOfIds.size() <= maxSelectionLimit) {
                    ...
                    CustomeToast.ShowCustomToast(getActivity(), message, Gravity.TOP);
//
                }
            } else {
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        selectedIdsForCallback = previouslySelectedIdsList;
        mainListOfAdapter = setCheckedIDS(mainListOfAdapter, selectedIdsForCallback);
        ArrayList<MultiSelectModel> filteredlist = filter(mainListOfAdapter, s.toString());
        mutliSelectAdapter.setData(filteredlist, s.toString().toLowerCase(), mutliSelectAdapter);
    }
