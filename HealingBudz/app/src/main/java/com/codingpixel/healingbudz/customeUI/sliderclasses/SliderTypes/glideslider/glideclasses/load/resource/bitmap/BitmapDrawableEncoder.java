...
public class BitmapDrawableEncoder implements ResourceEncoder<BitmapDrawable> {
  ...
  public boolean encode(@NonNull Resource<BitmapDrawable> data, @NonNull File file,
    ...
    return encoder.encode(new com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.resource.bitmap.BitmapResource(data.get().getBitmap(), bitmapPool), file, options);
  }
