 ...
 *     private static final String ID = "com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.transformations.FillSpace";
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
  ...
  public final Resource<Bitmap> transform(
    ...
    if (toTransform.equals(transformed)) {
      ...
      result = com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.resource.bitmap.BitmapResource.obtain(transformed, bitmapPool);
    }
    return result;
  }
