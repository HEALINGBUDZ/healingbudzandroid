...
import com.codingpixel.healingbudz.adapter.MyAnswersHistoryRecylerAdapter;
...
public class MyAnswersEditShowActivity extends AppCompatActivity implements APIResponseListner, MyAnswersHistoryRecylerAdapter.ItemClickListener, BackButtonClickListner {
    ...
    MyAnswersHistoryRecylerAdapter recyler_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_answers_edit);
        ChangeStatusBarColor(MyAnswersEditShowActivity.this, "#171717");
        Back = (ImageView) findViewById(R.id.back_btn);
        idAnswer = getIntent().getExtras().getInt("answer_id", 0);
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                GoToHome(MyAnswersEditShowActivity.this, true);
                finish();
            }
        });
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(MyAnswersEditShowActivity.this);
        My_questions_recyler_view.setLayoutManager(linearLayoutManager);
        recyler_adapter = new MyAnswersHistoryRecylerAdapter(this, main_data);
        My_questions_recyler_view.setAdapter(recyler_adapter);
        recyler_adapter.setClickListener(this);
        final JSONObject object = new JSONObject();
        Refresh.setVisibility(View.VISIBLE);
        pages = 0;
        new VollyAPICall(MyAnswersEditShowActivity.this, false, URL.get_edits + idAnswer, object, user.getSession_key(), Request.Method.GET, MyAnswersEditShowActivity.this, get_groups);
...
//                        String url = "";
////                        Refresh.setVisibility(View.VISIBLE);
//                        new VollyAPICall(MyAnswersEditShowActivity.this, false, URL.get_my_answers + "?page_no=" + pages, object, user.getSession_key(), Request.Method.GET, MyAnswersEditShowActivity.this, get_groups);
//                    }
//                }
            }
        });
...
//                }
                for (int x = 0; x < question_array.length(); x++) {
                    ...
                    dataModel.setId(json_object.getInt("answer_id"));
                    dataModel.setIdAns(json_object.getInt("id"));
                    dataModel.setText(json_object.optString("text"));
