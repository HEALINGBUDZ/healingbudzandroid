...
public class DetailsBusinessInfoCannabitesTabFragment extends Fragment implements APIResponseListner {
    ...
    View view;
    Button Call_User;
    TextView location, discription, instagram, zip_code, twitter, facebook, website, contact, email, not_found_payment;
    ...
    @SuppressLint("ValidFragment")
    public DetailsBusinessInfoCannabitesTabFragment(TabChangeListner tabChangeListner) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.details_business_info_cannabites_tab_layout, container, false);
        ...
        Show_product.setText("View Menu");
        Show_product.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (budz_map_item_clickerd_dataModel.getIs_featured() == 1) {
                    ...
                    new VollyAPICall(view.getContext(), false, URL.save_budz_menu_click, object, user.getSession_key(), Request.Method.POST, new APIResponseListner() {
                        @Override
    ...
    void apiCall(boolean loader) {
        ...
        if (isSearchedText) {
            ...
            isKeyy = true;
            JSONObject object = new JSONObject();
            new VollyAPICall(view.getContext(), false, URL.get_budz_profile + "/" + budz_map_item_clickerd_dataModel.getId() + "?keyword=" + isSearchedTextValue, object, user.getSession_key(), Request.Method.GET, DetailsBusinessInfoCannabitesTabFragment.this, get_budz_profile);
//            isSearchedTextValue = "";
        } else {
            if (isKeyy) {
            ...
            JSONObject object = new JSONObject();
            new VollyAPICall(view.getContext(), false, URL.get_budz_profile + "/" + budz_map_item_clickerd_dataModel.getId(), object, user.getSession_key(), Request.Method.GET, DetailsBusinessInfoCannabitesTabFragment.this, get_budz_profile);
        }
    }
    ...
    public void onRequestSuccess(String response, APIActions.ApiActions apiActions) {
        ...
        try {
            ...
            new SetReviewaAndComments().InitData(getContext(), DetailsBusinessInfoCannabitesTabFragment.this, view, reviews, jsonObject.getJSONObject("successData").getInt("get_user_review_count"));
