...
final class BitmapPreFillRunner implements Runnable {
  ...
  private final com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.engine.prefill.PreFillQueue toPrefill;
  private final Clock clock;
  private final Set<com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.engine.prefill.PreFillType> seenTypes = new HashSet<>();
  ...
  public BitmapPreFillRunner(
      BitmapPool bitmapPool, MemoryCache memoryCache, com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.engine.prefill.PreFillQueue allocationOrder) {
    this(
        bitmapPool,
        memoryCache,
        allocationOrder,
  ...
  BitmapPreFillRunner(
      ...
      com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.engine.prefill.PreFillQueue allocationOrder,
      Clock clock,
      Handler handler) {
