 ...
 */
public class UnitModelLoader<Model> implements com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.model.ModelLoader<Model, Model> {
  ...
  /**
   * Factory for producing {@link com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.model.UnitModelLoader}s.
   *
   * @param <Model> The type of model that will also be returned as decodable data.
   */
  ...
  public static class Factory<Model> implements ModelLoaderFactory<Model, Model> {
    ...
    @NonNull
    @Override
    public com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.model.ModelLoader<Model, Model> build(MultiModelLoaderFactory multiFactory) {
