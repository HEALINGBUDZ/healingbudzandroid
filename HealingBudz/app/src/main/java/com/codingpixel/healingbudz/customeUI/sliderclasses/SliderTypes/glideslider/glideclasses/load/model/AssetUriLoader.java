...
import com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.data.FileDescriptorAssetPathFetcher;
import com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.data.StreamAssetPathFetcher;
 ...
 */
public class AssetUriLoader<Data> implements com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.model.ModelLoader<Uri, Data> {
  ...
  public static class FileDescriptorFactory implements ModelLoaderFactory<Uri,
    ...
    @NonNull
    @Override
    public com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.model.ModelLoader<Uri, ParcelFileDescriptor> build(MultiModelLoaderFactory multiFactory) {
      return new AssetUriLoader<>(assetManager, this);
    }
