...
/**
 * A request that loads a resource for an {@link com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.request.target.Target}.
 */
public interface Request {
   ...
   * {@link com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.request.target.Target}s (for example). Using a similar but different
