...
public class RequestManagerRetriever implements Handler.Callback {
  @VisibleForTesting
  static final String FRAGMENT_TAG = "com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.manager";
  ...
  @VisibleForTesting
  final Map<android.app.FragmentManager, com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.manager.RequestManagerFragment> pendingRequestManagerFragments =
      new HashMap<>();
      ...
      synchronized (this) {
        if (applicationManager == null) {
          ...
          applicationManager =
              factory.build(
                  glide,
                  new com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.manager.ApplicationLifecycle(),
  ...
  @Deprecated
  @NonNull
  com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.manager.RequestManagerFragment getRequestManagerFragment(Activity activity) {
  ...
  @SuppressWarnings("deprecation")
  @NonNull
  private com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.manager.RequestManagerFragment getRequestManagerFragment(
      @NonNull final android.app.FragmentManager fm,
      @Nullable android.app.Fragment parentHint,
      boolean isParentVisible) {
    com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.manager.RequestManagerFragment current = (com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.manager.RequestManagerFragment) fm.findFragmentByTag(FRAGMENT_TAG);
    if (current == null) {
      current = pendingRequestManagerFragments.get(fm);
      if (current == null) {
        current = new com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.manager.RequestManagerFragment();
  ...
  public interface RequestManagerFactory {
    ...
    RequestManager build(
            @NonNull Glide glide,
            @NonNull com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.manager.Lifecycle lifecycle,
            @NonNull com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.manager.RequestManagerTreeNode requestManagerTreeNode,
            @NonNull Context context);
  }
