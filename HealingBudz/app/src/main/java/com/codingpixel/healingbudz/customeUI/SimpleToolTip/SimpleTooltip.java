package com.codingpixel.healingbudz.customeUI.SimpleToolTip;
...
public class SimpleTooltip implements PopupWindow.OnDismissListener {
    ...
    private SimpleTooltip.OnDismissListener mOnDismissListener;
    private SimpleTooltip.OnShowListener mOnShowListener;
    ...
    private SimpleTooltip(SimpleTooltip.Builder builder) {
    ...
    private PointF calculePopupLocation() {
        ...
        switch (mGravity) {
            ...
            case Gravity.TOP:
                ...
                break;
            case Gravity.BOTTOM:
                location.x = (anchorCenter.x  - mPopupWindow.getContentView().getWidth() / 3f) + 90;
    ...
    public static class Builder {
        ...
        private SimpleTooltip.OnDismissListener onDismissListener;
        private SimpleTooltip.OnShowListener onShowListener;
         ...
         */
        public SimpleTooltip.Builder contentView(TextView textView) {
         ...
         * @see SimpleTooltip.Builder#contentView(int)
         */
        public SimpleTooltip.Builder contentView(View contentView, @IdRes int textViewId) {
         ...
         * @see SimpleTooltip.Builder#contentView(int)
         */
        public SimpleTooltip.Builder contentView(@LayoutRes int contentViewId, @IdRes int textViewId) {
         ...
         * @see SimpleTooltip.Builder#contentView(int, int)
         */
        public SimpleTooltip.Builder contentView(@LayoutRes int contentViewId) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            this.contentView = inflater.inflate(contentViewId, null, false);
            this.textViewId = 0;
            return this;
         ...
         */
        public SimpleTooltip.Builder dismissOnInsideTouch(boolean dismissOnInsideTouch) {
         ...
         */
        public SimpleTooltip.Builder dismissOnOutsideTouch(boolean dismissOnOutsideTouch) {
         ...
         * @see SimpleTooltip.Builder#dismissOnOutsideTouch(boolean)
         */
        public SimpleTooltip.Builder modal(boolean modal) {
            this.modal = modal;
            return this;
        }
         ...
         * @return this
         */
        public SimpleTooltip.Builder text(CharSequence text) {
            this.text = text;
            return this;
        }
         ...
         * @return this
         */
        public SimpleTooltip.Builder text(@StringRes int textRes) {
         ...
         * @return this
         */
        public SimpleTooltip.Builder anchorView(View anchorView) {
         ...
         * @return this
         */
        public SimpleTooltip.Builder gravity(int gravity) {
         ...
         * @return this
         */
        public SimpleTooltip.Builder arrowDirection(int arrowDirection) {
         ...
         * @return this
         */
        public SimpleTooltip.Builder transparentOverlay(boolean transparentOverlay) {
         ...
         */
        public SimpleTooltip.Builder maxWidth(@DimenRes int maxWidthRes) {
         ...
         */
        public SimpleTooltip.Builder maxWidth(float maxWidth) {
         ...
         */
        @TargetApi(Build.VERSION_CODES.HONEYCOMB)
        public SimpleTooltip.Builder animated(boolean animated) {
         ...
         */
        @TargetApi(Build.VERSION_CODES.HONEYCOMB)
        public SimpleTooltip.Builder animationPadding(float animationPadding) {
         ...
         */
        @TargetApi(Build.VERSION_CODES.HONEYCOMB)
        public SimpleTooltip.Builder animationPadding(@DimenRes int animationPaddingRes) {
            this.animationPadding = context.getResources().getDimension(animationPaddingRes);
            return this;
        }

        @TargetApi(Build.VERSION_CODES.HONEYCOMB)
        public SimpleTooltip.Builder animationDuration(long animationDuration) {
         ...
         */
        public SimpleTooltip.Builder padding(@DimenRes int paddingRes) {
         ...
         */
        public SimpleTooltip.Builder margin(float margin) {
            this.margin = margin;
            return this;
        }
         ...
         */
        public SimpleTooltip.Builder margin(@DimenRes int marginRes) {
            this.margin = context.getResources().getDimension(marginRes);
            return this;
        }

        public SimpleTooltip.Builder textColor(int textColor) {
            this.textColor = textColor;
            return this;
        }

        public SimpleTooltip.Builder backgroundColor(@ColorInt int backgroundColor) {
        ...
        public SimpleTooltip.Builder arrowDrawable(Drawable arrowDrawable) {
        ...
        public SimpleTooltip.Builder arrowColor(@ColorInt int arrowColor) {
         ...
         * @return this
         */
        public SimpleTooltip.Builder arrowWidth(float arrowWidth) {
            this.arrowWidth = arrowWidth;
            return this;
        }

        public SimpleTooltip.Builder onDismissListener(SimpleTooltip.OnDismissListener onDismissListener) {
         ...
         */
        public SimpleTooltip.Builder highlightShape(int highlightShape) {
            this.highlightShape = highlightShape;
            return this;
        }

        /**
         * <div class="pt">Tamanho da margem entre {@link SimpleTooltip.Builder#anchorView(View)} e a borda do Shape de destaque.
         * Este valor sobrescreve <tt>{@link R.dimen.simpletooltip_overlay_offset}</tt></div>
         * <div class="en">Margin between {@link SimpleTooltip.Builder#anchorView(View)} and highlight Shape border.
         ...
         * @see SimpleTooltip.Builder#transparentOverlay(boolean)
         */
        public SimpleTooltip.Builder overlayOffset(@Dimension float overlayOffset) {
         ...
         * @return this
         */
        public SimpleTooltip.Builder overlayMatchParent(boolean overlayMatchParent) {
