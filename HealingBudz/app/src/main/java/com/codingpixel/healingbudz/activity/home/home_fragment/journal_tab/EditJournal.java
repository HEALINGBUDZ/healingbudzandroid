...
public class EditJournal extends AppCompatActivity implements APIResponseListner {
    ImageView Back, Home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChangeStatusBarColor(EditJournal.this, "#0a0a0a");
        HideKeyboard(EditJournal.this);
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                GoToHome(EditJournal.this, true);
                finish();
            }
        });
        ...
        Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (entry_title.getText().length() > 0) {
                    ...
                    journalFragmentDataModel.setTitle(entry_title.getText().toString());
                    new VollyAPICall(EditJournal.this, true, URL.update_journal, object, user.getSession_key(), Request.Method.POST, EditJournal.this, get_groups);
                }
            }
        });

        if (journalFragmentDataModel.getIs_public() == 0) {
            isPublic = false;
            isPrivate = true;
            btn_private.setBackgroundResource(R.drawable.toggle_btn_private);
            btn_public.setBackground(null);
...
//        entry_title.setText(journalFragmentDataModel.getTitle());
        MakeKeywordClickableText(entry_title.getContext(), journalFragmentDataModel.getTitle(), entry_title);
        Save.setText("Update");
    }
