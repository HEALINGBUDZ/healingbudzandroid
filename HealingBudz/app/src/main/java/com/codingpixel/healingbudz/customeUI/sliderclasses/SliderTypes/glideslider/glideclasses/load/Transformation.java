 ...
 * cache and {@link #updateDiskCacheKey(MessageDigest)}} to identify the
 ...
 */
public interface Transformation<T> extends com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.Key {
   ...
   * com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *                  com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.request.target.Target#SIZE_ORIGINAL} to indicate the
