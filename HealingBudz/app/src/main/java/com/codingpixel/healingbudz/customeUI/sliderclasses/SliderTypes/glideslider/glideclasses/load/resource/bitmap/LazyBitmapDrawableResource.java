...
public final class LazyBitmapDrawableResource implements Resource<BitmapDrawable>,
    ...
    return
        (LazyBitmapDrawableResource)
            obtain(
                ...
                com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.resource.bitmap.BitmapResource.obtain(bitmap, Glide.get(context).getBitmapPool()));
  }
  ...
  public static LazyBitmapDrawableResource obtain(Resources resources, BitmapPool bitmapPool,
      Bitmap bitmap) {
    return
        (LazyBitmapDrawableResource) obtain(resources, com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.resource.bitmap.BitmapResource.obtain(bitmap, bitmapPool));
  }
