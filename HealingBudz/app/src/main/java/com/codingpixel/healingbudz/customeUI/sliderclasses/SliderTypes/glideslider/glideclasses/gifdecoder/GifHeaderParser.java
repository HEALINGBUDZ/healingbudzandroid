...
import static com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.gifdecoder.GifDecoder.STATUS_FORMAT_ERROR;
...
/**
 * A class responsible for creating {@link com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.gifdecoder.GifHeader}s from data
...
public class GifHeaderParser {
   ...
   *
   * @see com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.gifdecoder.GifFrame.GifDisposalMethod possible values
   */
  ...
  public GifHeaderParser setData(@Nullable byte[] data) {
    if (data != null) {
      ...
      rawData = null;
      header.status = com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.gifdecoder.GifDecoder.STATUS_OPEN_ERROR;
    }
    return this;
  }
  ...
  @NonNull
  public com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.gifdecoder.GifHeader parseHeader() {
    if (rawData == null) {
      ...
      switch (code) {
        case IMAGE_SEPARATOR:
          ...
          if (header.currentFrame == null) {
            header.currentFrame = new com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.gifdecoder.GifFrame();
          }
          readBitmap();
          break;
