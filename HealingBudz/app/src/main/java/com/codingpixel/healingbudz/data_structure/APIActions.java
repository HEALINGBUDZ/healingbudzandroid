package com.codingpixel.healingbudz.data_structure;
...
public class APIActions {
    public static enum ApiActions {
        ...
        add_strain_review, upload_strain_image, flag_strain_review, get_budz_map, delete_my_save, get_my_strains, filter_my_save, get_notifications, get_shout_outs, add_shout_out, delete_answer, global_search, get_my_journals_calander, get_journal_settings, add_subscription, get_languages, get_budz_profile,
