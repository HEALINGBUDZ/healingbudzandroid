...
public class ReviewRecylerGroupViewHolder extends GroupViewHolder {
  private ImageView arrow;
  public TextView Date_Title;
  public ReviewRecylerGroupViewHolder(View itemView) {
    super(itemView);
    arrow = itemView.findViewById(R.id.arrow_journal_list);
    Date_Title = itemView.findViewById(R.id.heading_title);
  }
