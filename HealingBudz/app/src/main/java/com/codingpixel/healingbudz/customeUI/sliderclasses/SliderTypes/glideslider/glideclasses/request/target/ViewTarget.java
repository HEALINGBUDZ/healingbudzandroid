...
/**
 * A base {@link com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.request.target.Target} for loading {@link android.graphics.Bitmap}s into {@link View}s that
 ...
 * View#setTag(Object)} on a view, consider using {@link com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.request.target.BaseTarget} or {@link SimpleTarget}
 * instead. </p>
 *
...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
   ...
   *   on older versions, be sure to call {@link com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.RequestManager#clear(View)} on
