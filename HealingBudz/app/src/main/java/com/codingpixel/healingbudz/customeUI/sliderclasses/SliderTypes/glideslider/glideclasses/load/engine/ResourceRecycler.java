...
class ResourceRecycler {
  ...
  void recycle(com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.engine.Resource<?> resource) {
  ...
  private static final class ResourceRecyclerCallback implements Handler.Callback {
    ...
    public boolean handleMessage(Message message) {
      if (message.what == RECYCLE_RESOURCE) {
        com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.engine.Resource<?> resource = (com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.engine.Resource<?>) message.obj;
        resource.recycle();
        return true;
      }
      return false;
