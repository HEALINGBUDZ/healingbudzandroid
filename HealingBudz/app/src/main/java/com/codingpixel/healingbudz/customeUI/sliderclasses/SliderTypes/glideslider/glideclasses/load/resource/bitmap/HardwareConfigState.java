...
final class HardwareConfigState {
   ...
   * and/or a sufficiently large {@link com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.engine.cache.MemoryCache}, we can
  ...
  private synchronized boolean isFdSizeBelowHardwareLimit() {
    if (++decodesSinceLastFdCheck >= MINIMUM_DECODES_BETWEEN_FD_CHECKS) {
      ...
      if (!isHardwareConfigAllowed && Log.isLoggable(com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.resource.bitmap.Downsampler.TAG, Log.WARN)) {
        Log.w(com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.resource.bitmap.Downsampler.TAG,
