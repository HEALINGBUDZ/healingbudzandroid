...
final class DrawableToBitmapConverter {
  ...
  static Resource<Bitmap> convert(BitmapPool bitmapPool, Drawable drawable, int width, int height) {
    ...
    return com.codingpixel.healingbudz.customeUI.sliderclasses.SliderTypes.glideslider.glideclasses.load.resource.bitmap.BitmapResource.obtain(result, toUse);
  }
